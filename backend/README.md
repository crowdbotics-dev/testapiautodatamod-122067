...
## Project Structure
    ...
    ├── testapiautodatamod_122067  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_122067`
...
2. Clone this repo and `cd testapiautodatamod_122067`
